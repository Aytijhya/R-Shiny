...
```{r, echo=FALSE, fig.cap="Blackbox diagram", out.height='20%', out.width = '40%', fig.align='center'}
knitr::include_graphics(path ="/Users/aytijhyasaha/Documents/blackbox.png" )
```
## Design Matrix
